...
{
    [AddComponentMenu("UI/Custom Toggle Group", 31)]
    ...
    public class CustomToggleGroup : UIBehaviour
    {
        ...
        protected List<CustomToggle> m_Toggles = new List<CustomToggle>();
        ...
        public void EnsureValidState()
        {
            ...
            {
                CustomToggle firstActive = GetFirstActiveToggle();

                foreach (CustomToggle toggle in activeToggles)
                {
