...
namespace UnityEngine.UI
{
    ...
    /// </remarks>
    [AddComponentMenu("UI/CustomToggle", 30)]
    [RequireComponent(typeof(RectTransform))]
    public class CustomToggle : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
    {
        /// <summary>
        ...
        public ToggleEvent onValueInverseChanged = new ToggleEvent();
        ...
        public virtual void Rebuild(CanvasUpdate executing)
        {
            ...
            if (executing == CanvasUpdate.Prelayout)
            {
                ...
                onValueInverseChanged.Invoke(!m_IsOn); 
            }
#endif
        }
